...
#cfg.merge_from_file(model_zoo.get_config_file('SwinT/faster_rcnn_swint_T_FPN_3x.yaml'))
...
cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, 'model_0053499.pth')
...
for data in tqdm(test_loader):
    ...
    for target, box, score in zip(targets,boxes,scores):
        prediction_list.append(str(target) + ' ' + str(score) + ' ' + str(box[0]) + ' ' 
...
submission.to_csv(os.path.join(cfg.OUTPUT_DIR, f'faster_rcnn_R_101_FPN_3x_detectron2_no_every.csv'), index=None)
submission.head()