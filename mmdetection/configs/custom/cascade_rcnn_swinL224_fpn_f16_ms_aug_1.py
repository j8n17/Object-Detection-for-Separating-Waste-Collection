...
# model settings
# aug1 : randomratate90, HueSaturationValue 
model = dict(
    type='CascadeRCNN',
    backbone=dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', #interval=1000,
            init_kwargs=dict(
                ...
                name = "cascade_rcnn_swinL224_fpn_f16_ms_aug_1" #'실험할때마다 RUN에 찍히는 이름'
            ),
            )
...
work_dir = '/opt/ml/detection/baseline/mmdetection/work_dirs/cascade_rcnn_aug_1'
