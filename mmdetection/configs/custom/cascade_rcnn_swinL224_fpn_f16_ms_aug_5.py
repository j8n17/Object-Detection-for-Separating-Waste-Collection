...
# model settings
# aug5 : CLAHE, ColorJitter, RandomSizedBBoxCrop
model = dict(
    type='CascadeRCNN',
    backbone=dict(
...
train_pipeline = [
    ...
    dict(
        ...
        transforms=[    
            ...
            dict(type='ColorJitter', contrast=7.5, p = 1),
            dict(type='CLAHE', p = 1)],
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', #interval=1000,
            init_kwargs=dict(
                ...
                name = "cascade_rcnn_swinL224_fpn_f16_ms_tta_aug_5" #'실험할때마다 RUN에 찍히는 이름'
            ),
            )
...
work_dir = '/opt/ml/detection/baseline/mmdetection/work_dirs/cascade_rcnn_aug_5'
