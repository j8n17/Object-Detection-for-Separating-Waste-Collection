...
def parse_args():
    ...
    parser.add_argument("--name", type = str, default = "result", help = 'submission file name')
...
def make_submisson_csv(annotation_file_route, outputs):
    prediction_strings = []
    file_names = []
