...
def main(args):
    ...
    submission.to_csv(f"{args.submission_path}/submission_{args.save_name}.csv", index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_name", type=str, default="yolov5l6", help="File name want to save (default: 'yolov5l6')")
