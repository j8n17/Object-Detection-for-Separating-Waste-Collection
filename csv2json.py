...
def main(args):
    ...
    inference_df = csv2df(args.inference_dir, confidence = float(args.confidence))

    save_dir = os.path.join('/'.join(args.test_dir.split('/')[:-1]), f'pesudo_conf{args.confidence}_test.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inference_dir', default='/opt/ml/detection/utils/ensemble_models/swin_arug.csv')
